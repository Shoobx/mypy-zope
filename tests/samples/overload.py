...
"""
<output>
overload.py:48: note: Revealed type is "Overload(def (index: int) -> int, def (index: None =) -> list[int])"
overload.py:49: note: Revealed type is "Overload(def (index: int) -> int, def (index: None =) -> list[int])"
</output>
"""
